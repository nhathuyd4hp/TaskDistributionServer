...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler(f"{'Access_token_log'}"), logging.StreamHandler(sys.stdout)],
)
...
target_folder_path = "インド事務所関係/Access_token"
...
if token_file:
    ...
    logging.info("token file downloaded successfully")
else:
